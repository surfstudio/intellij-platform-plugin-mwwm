...
public class DynamicActionGroup extends ActionGroup {
     ...
     */
    @NotNull @Override public AnAction @NotNull [] getChildren(AnActionEvent e) {
        return new AnAction[]{
                new PopupDialogAction("Create widget", "Dynamic Action Demo", null, true),
                new PopupDialogAction("Create screen", "Dynamic Action Demo", null, false),};
    }
